...
class FBPLPPDialog(QDialog):
    def __init__(self, main_window):
        ...
        # Testo di aiuto
        self.help_text_fbp_lpp_unet2_window = (
            "<h3>Guida alla FBP + LPP Reconstruction (U-Net 2)</h3>"
            "<p>In questa sezione è possibile:</p>"
            "<ul>"
            "<li><b>Carica Modello:</b> Cliccando sul bottone è possibile selezionare un modello correttamente addestrato e compatibile alla U-Net utilizzata [U-Net 2] (per la lista dei modelli e per il training dei modelli, andare sulla cartella 'Models').</li>"
    ...
    def event(self, event):
        ...
        if event.type() == QEvent.EnterWhatsThisMode and self.isActiveWindow():
            ...
            self.show_help_fbp_lpp_unet2_window()
    ...
    def show_help_fbp_lpp_unet2_window(self):
        ...
        help_box.setText(self.help_text_fbp_lpp_unet2_window)
